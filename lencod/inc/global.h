...
int frame_changing_check_hw;

unsigned int pre_frame_info_hw[999][999];
double SAFD_hw;
unsigned int pre_frame_block_info_hw[999][999];
double SAD_hw;
double w_value_hw;
//imgpel  *srcptr_temp_hw = orig_pels_temp_hw;
...
{
    Boolean              fast_inter_decision_hw;
    Boolean                fast_intra_decision_hw;
